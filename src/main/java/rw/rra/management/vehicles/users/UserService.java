...
public class UserService {
    ...
    @Value("${admin.email:aimablebyumvuhore@gmail.com}")
    private String adminEmail;

    @Value("${admin.password:Aimable@2025}")
    ...
    public void createAdminUserIfNotExists() {
        ...
        if (!userRepository.findByEmail(adminEmail).isPresent()) {
            ...
            adminUser.setFirstName("BYUMVUHORE");
            adminUser.setLastName("Aimable");
            adminUser.setEnabled(true);
            adminUser.setStatus(Status.ACTIVE);
            adminUser.setPhoneNumber("0796004898");
            adminUser.setNationalId("1199780233034090");
            ...
            log.info("Admin user 'Aimable' created.");
        } else {
            log.info("Admin user 'Aimable' already exists.");
        }
    }
